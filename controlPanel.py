...
DEFAULT_SETTINGS = {'lengthChannel_input': 'Dev2/ai0',
                    ...
                    'xMirror_input': 'Dev2/ai2',
                    'yMirror_input': 'Dev2/ai3',
                    'lengthChannel_output': 'Dev2/ao0',
                    'forceChannel_output': 'Dev2/ao1',
                    'xMirror_output': 'Dev2/ao2',
                    'yMirror_output': 'Dev2/ao3',
...
SETTINGS_KEYS_TO_ELEMENT_KEYS = {'lengthChannel_input': '-LENGTH IN-',
                                 ...
                                 'xMirror_input': '-XMIRROR IN-',
                                 'yMirror_input': '-YMIRROR IN-',
                                 'lengthChannel_output': '-LENGTH OUT-',
                                 'forceChannel_output' : '-FORCE OUT-',
                                 'xMirror_output': '-XMIRROR OUT-',
                                 'yMirror_output': '-YMIRROR OUT-',
...
def create_settings_window(settings):
    ...
    layout = [  [sg.Text('DAQ Settings', font='Any 15')],
                ...
                [TextLabel('XMIRROR Input'),sg.Input(key='-XMIRROR IN-')],
                [TextLabel('YMIRROR Input'),sg.Input(key='-YMIRROR IN-')],
                [TextLabel('Length Output'),sg.Input(key='-LENGTH OUT-')],
                [TextLabel('Force Output'),sg.Input(key='-FORCE OUT-')],
                [TextLabel('XMIRROR Output'),sg.Input(key='-XMIRROR OUT-')],
                [TextLabel('YMIRROR Output'),sg.Input(key='-YMIRROR OUT-')],
